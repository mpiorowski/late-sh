...
LATE_WEB_TUNNEL_URL ?= ws://service-ssh:$(strip $(LATE_TUNNEL_PORT))/tunnel  # Internal /tunnel URL used by web spectators
LATE_WEB_TUNNEL_SHARED_SECRET ?= $(LATE_TUNNEL_SHARED_SECRET)       # Must match LATE_TUNNEL_SHARED_SECRET on the backend
LATE_WEB_SPECTATOR_USERNAME ?= spectator                    # Synthetic anonymous spectator username
LATE_WEB_SPECTATOR_FINGERPRINT ?= web-spectator:v1          # Synthetic anonymous spectator fingerprint
LATE_WEB_SPECTATOR_DEFAULT_COLS ?= 120
LATE_WEB_SPECTATOR_DEFAULT_ROWS ?= 40
LATE_WEB_SPECTATOR_MAX_COLS ?= 300
LATE_WEB_SPECTATOR_MAX_ROWS ?= 100
...
.env:
	...
	@echo "LATE_WEB_TUNNEL_URL=$(LATE_WEB_TUNNEL_URL)" >> .env
	@echo "LATE_WEB_TUNNEL_SHARED_SECRET=$(LATE_WEB_TUNNEL_SHARED_SECRET)" >> .env
	@echo "LATE_WEB_SPECTATOR_USERNAME=$(LATE_WEB_SPECTATOR_USERNAME)" >> .env
	@echo "LATE_WEB_SPECTATOR_FINGERPRINT=$(LATE_WEB_SPECTATOR_FINGERPRINT)" >> .env
	@echo "LATE_WEB_SPECTATOR_DEFAULT_COLS=$(LATE_WEB_SPECTATOR_DEFAULT_COLS)" >> .env
	@echo "LATE_WEB_SPECTATOR_DEFAULT_ROWS=$(LATE_WEB_SPECTATOR_DEFAULT_ROWS)" >> .env
	@echo "LATE_WEB_SPECTATOR_MAX_COLS=$(LATE_WEB_SPECTATOR_MAX_COLS)" >> .env
	@echo "LATE_WEB_SPECTATOR_MAX_ROWS=$(LATE_WEB_SPECTATOR_MAX_ROWS)" >> .env
