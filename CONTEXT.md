...
| LeWordGame | `le_word_games` | `UNIQUE(user_id, puzzle_date)`, stores dated daily progress |
| LeWordReplayGame | `le_word_replay_games` | `user_id` UNIQUE, stores one replaceable random-word replay board per user |
