...
- Last updated: 2026-08-21 (bug sweep from #bugs: SSH compression pinned off, every screen change repaints in full, Arcade dailies roll over at UTC midnight inside a live session, a mention clears when its room is read, an edited message keeps its own header, image uploads keep their reply, Snake's board follows the theme, a solved daily cube refuses reset)
- Status: Active
