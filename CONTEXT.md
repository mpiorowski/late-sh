...
- Last updated: 2026-08-22 (Username effects gained a month tier: Name Glow / Name Gradient / Name Shimmer now sell a 30-day option under each 24h item at 30x the price, migration 146. The tier is payload-only, so the picker, purchase path, and flair pipeline are unchanged; shop copy, the purchase banner, and the #lounge line quote the bought window. Details in `late-ssh/src/app/hub/CONTEXT.md`)
- Status: Active
