...
| `↑` / `↓` / `j` / `k` | Profile/settings modal | Move between rows (Username, Theme, Background, Right sidebar, Country, Timezone, DMs, @mentions, Game events, Bell, Cooldown, Format) |
