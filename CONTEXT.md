...
- Last updated: 2026-07-02 (Clubhouse tavern as admin-gated top-level screen `0`: zoomed free-roam ASCII Late Lounge generated by `scripts/gen_clubhouse_map.py`, live-user seating, page-signpost landmarks, embedded #lounge chat, and the new @bartender ghost bot)
- Status: Active
