...
- Last updated: 2026-07-22 (World Cup screen removed entirely: the `app/worldcup` module, its FotMob poller/service, `Screen::WorldCup`, all wiring in input/render/tick/state, the kitty-flag-column detection it was the sole consumer of, and every doc/help/keybinding reference to it. Top-level tab cycle is now Clubhouse `0` through Directory `5`, six screens instead of seven)
- Status: Active
