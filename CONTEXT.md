...
- Last updated: 2026-08-19 (A Dark Room now has a real ending: winning the ascent shows a full-panel epitaph, pays 10,000 chips and the rankless `ADE` badge once per account, and deletes the save so the next visit starts from a dead fire. Details in `late-ssh/src/app/door/darkroom/CONTEXT.md` "The ending" and `late-ssh/src/app/leaderboard/CONTEXT.md`)
- Status: Active
