...
/// What this SSH session runs: a nethack child on a PTY (a player), or the
...
pub(crate) struct ClientHandler {
    ...
    /// The running NetHack child or stats stream, once the shell is requested.
...
impl Handler for ClientHandler {
    ...
    async fn channel_eof(
        ...
        // (SIGHUP-save for a game, stream stop for a stats session).
        self.host = None;
        Ok(())
    }
