...
/// The Dynamic Bonsai preview block plus its footer row; classic scales to it.
const BONSAI_MIN_HEIGHT: u16 = crate::app::bonsai_v2::render::PREVIEW_HEIGHT as u16 + 1;
