...
pub const CART_SIGNS: &[Sign] = &[
    ...
    Sign { zone: Zone { x0: 79, y0: 20, x1: 79, y1: 20 }, color: Neon::Cyan },
...
pub const BILLBOARDS: &[Sign] = &[
    Sign { zone: Zone { x0: 30, y0: 2, x1: 47, y1: 2 }, color: Neon::Magenta },
    Sign { zone: Zone { x0: 150, y0: 2, x1: 169, y1: 2 }, color: Neon::Cyan },
    Sign { zone: Zone { x0: 236, y0: 2, x1: 253, y1: 2 }, color: Neon::Amber },
    Sign { zone: Zone { x0: 330, y0: 2, x1: 347, y1: 2 }, color: Neon::Green },
    Sign { zone: Zone { x0: 400, y0: 2, x1: 415, y1: 2 }, color: Neon::Red },
    Sign { zone: Zone { x0: 300, y0: 27, x1: 315, y1: 27 }, color: Neon::Cyan },
    Sign { zone: Zone { x0: 350, y0: 33, x1: 365, y1: 33 }, color: Neon::Magenta },
    Sign { zone: Zone { x0: 405, y0: 26, x1: 420, y1: 26 }, color: Neon::Amber },
    Sign { zone: Zone { x0: 330, y0: 38, x1: 343, y1: 38 }, color: Neon::Red },
];
...
pub const LIGHTS: &[Light] = &[
    ...
    Light { x: 38, y: 2, kind: LightKind::Billboard, color: Neon::Magenta, radius: 5 },
    Light { x: 159, y: 2, kind: LightKind::Billboard, color: Neon::Cyan, radius: 5 },
    Light { x: 244, y: 2, kind: LightKind::Billboard, color: Neon::Amber, radius: 5 },
    Light { x: 338, y: 2, kind: LightKind::Billboard, color: Neon::Green, radius: 5 },
    Light { x: 407, y: 2, kind: LightKind::Billboard, color: Neon::Red, radius: 5 },
    Light { x: 307, y: 27, kind: LightKind::Billboard, color: Neon::Cyan, radius: 5 },
    Light { x: 357, y: 33, kind: LightKind::Billboard, color: Neon::Magenta, radius: 5 },
    Light { x: 412, y: 26, kind: LightKind::Billboard, color: Neon::Amber, radius: 5 },
    Light { x: 336, y: 38, kind: LightKind::Billboard, color: Neon::Red, radius: 5 },
    ...
    Light { x: 67, y: 21, kind: LightKind::Door, color: Neon::Red, radius: 3 },
...
impl Landmark {
    ...
    pub fn reach(self) -> Zone {
        match self {
            ...
            Landmark::Umbrellas => Zone { x0: 74, y0: 20, x1: 79, y1: 20 },
