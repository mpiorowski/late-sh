...
fn cli_youtube_lines() -> Vec<String> {
    [
        ...
        "small companion webview window. That window hosts the official",
        "YouTube IFrame Player. The CLI still handles SSH, chat, queue",
        "controls, mute/volume keys, and Icecast playback.",
        "",
        ...
        "",
        "Operational notes",
        "  The helper starts only while your source is YouTube, and closes",
        ...
        "  No webview, or it will not start? late.sh/listen plays the same",
        "  queue in any browser, including on a phone.",
    ]
    .into_iter()
    .map(str::to_string)
    .collect()
