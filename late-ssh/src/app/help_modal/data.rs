...
pub fn chat_help_lines(keep_composer_focused: bool) -> Vec<String> {
    ...
    let mut lines: Vec<String> = [
        ...
        "  Ctrl+G             open Hub",
        "  /aquarium          toggle your Aquarium tray after unlocking it in Shop",
        "  /aquarium feed     feed your Aquarium tray with bought Aquarium Food",
...
fn overview_lines() -> Vec<String> {
    [
        ...
        "  Ctrl+G            open Hub",
        "  /aquarium         toggle Aquarium tray after unlocking it in Shop",
        "  /aquarium feed    feed Aquarium tray with bought Aquarium Food",
        "  Ctrl+/            search and jump to a room, DM, or synthetic Home entry",
        "  ?                 open this guide; Pair and terminal-specific tabs live here",
        "  w                 open Bonsai Care when not composing",
        "  /feed /water /treat  pet-strip care after unlocking the companion",
...
fn bonsai_help_lines() -> Vec<String> {
    [
        ...
        "  strip             lives above the chat composer once unlocked",
        "  /feed             feed (every 2 days), or click the food bowl",
        "  /water            water (daily), or click the water bowl",
        "  /treat            daily pet-food treat, or click the pet; it strolls",
        "  /petname [name]   show or set your pet's name",
