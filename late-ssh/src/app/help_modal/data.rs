...
fn rooms_help_lines() -> Vec<String> {
    [
        ...
        "  Chess             name, clock preset",
        "  Tron              name, speed (admin/mod only)",
        "  Poker / TTT       name only",
        "",
        "Active room",
        ...
        "",
        "Chess",
        "  Two seats, White and Black, no chips.",
        "  Clock presets     blitz, rapid, and 1d/move daily",
        "  s / Space / Enter sit as viewer",
        "  n                 start when both players are seated",
        "  w/a/s/d or arrows move cursor while seated",
        "  Space / Enter     select piece, then destination",
        "  r                 resign active game",
        "  l                 leave seat before/after a game",
        "",
        "Tron",
        "  Admin/mod only. Four seats, light-cycle trails, no chips.",
        "  Speed             chill, standard, quick",
        "  s / Space / Enter sit as viewer",
        "  n                 start when at least two riders are seated",
        "  w/a/s/d or arrows steer while seated",
        "  l                 leave seat",
        "",
        "Tic-Tac-Toe",
