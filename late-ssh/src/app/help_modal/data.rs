...
pub fn chat_help_lines() -> Vec<String> {
    [
        ...
        "",
        "Showcases room",
        "  A synthetic room where users post project links. Order is reshuffled on each visit.",
        ...
        "",
        "Work room",
        "  A synthetic room where users post one work profile. Order is reshuffled on each visit.",
