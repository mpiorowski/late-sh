...
fn directory_help_lines() -> Vec<String> {
    [
        ...
        "  skills            typed freely; the tags the job matcher knows show under the row as you type, the rest stay as free tags",
        ...
        "",
        "Jobs shelf",
        "  Remote postings pulled daily from feeds built to be read, matched to the tags on your card. Landing soon; the shelf says so until then.",
        "",
        "Public web profile",
