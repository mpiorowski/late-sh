...
pub fn chat_help_lines() -> Vec<String> {
    [
        ...
        "  /mod               open the moderation command modal",
...
fn social_help_lines() -> Vec<String> {
    [
        ...
        "  Order is reshuffled on each visit.",
        "  j / k or ↑ / ↓   navigate showcases",
        "  Enter             copy selected URL",
        "  i                 create a showcase",
        "  e                 edit your own showcase (admin: any)",
...
fn rooms_help_lines() -> Vec<String> {
    [
        ...
        "  Poker / TTT       name only",
        "  Poker             admin/mod only to create or enter",
        "",
        "Active room",
...
fn settings_help_lines() -> Vec<String> {
    ...
    vec![
        ...
        "  Special           conditional admin/special-user toggles".to_string(),
        "".to_string(),
