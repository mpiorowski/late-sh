...
impl HelpTopic {
    ...
    pub fn title(self) -> &'static str {
        use crate::app::common::i18n;
        match self {
            HelpTopic::Pair => i18n::tr("help.topic.pair"),
            HelpTopic::Overview => i18n::tr("help.topic.overview"),
            HelpTopic::Architecture => i18n::tr("help.topic.architecture"),
            HelpTopic::Chat => i18n::tr("help.topic.chat"),
            HelpTopic::Irc => i18n::tr("help.topic.irc"),
            HelpTopic::Social => i18n::tr("help.topic.social"),
            HelpTopic::Directory => i18n::tr("help.topic.directory"),
            HelpTopic::News => i18n::tr("help.topic.news"),
            HelpTopic::Arcade => i18n::tr("help.topic.arcade"),
            HelpTopic::Lobby => i18n::tr("help.topic.lobby"),
            HelpTopic::Lateania => i18n::tr("help.topic.lateania"),
            HelpTopic::TerminalCopy => i18n::tr("help.topic.terminal_copy"),
            HelpTopic::TerminalLinks => i18n::tr("help.topic.terminal_links"),
            HelpTopic::TerminalImages => i18n::tr("help.topic.terminal_images"),
            HelpTopic::TerminalSelection => i18n::tr("help.topic.terminal_selection"),
            HelpTopic::TerminalNotifications => i18n::tr("help.topic.terminal_notifications"),
            HelpTopic::TerminalCliYoutube => i18n::tr("help.topic.terminal_cli_youtube"),
            HelpTopic::Economy => i18n::tr("help.topic.economy"),
            HelpTopic::Bonsai => i18n::tr("help.topic.bonsai"),
            HelpTopic::Settings => i18n::tr("help.topic.settings"),
            HelpTopic::Voice => i18n::tr("help.topic.voice"),
        }
    }
...
fn pair_help_lines(pair_url: &str) -> Vec<String> {
    ...
    let mut lines = vec![
        i18n::tr("help.heading.install_pair").to_string(),
        "".to_string(),
        ...
        "".to_string(),
        i18n::tr("help.heading.install").to_string(),
        ...
        "".to_string(),
        i18n::tr("help.heading.what_late_unlocks").to_string(),
        ...
        "".to_string(),
        i18n::tr("help.heading.browser_pairing").to_string(),
...
pub(crate) fn chat_help_lines(keep_composer_focused: bool) -> Vec<String> {
    ...
    let mut lines: Vec<String> = [
        ...
        "",
        i18n::tr("help.heading.global_chat_keys"),
        ...
        "",
        i18n::tr("help.heading.icon_picker"),
        ...
        "  Esc                close",
        "",
        i18n::tr("help.heading.overlay_windows"),
        "  Esc / q            close overlay",
        "  j / k              scroll overlay",
        "  image modal        Enter/c copy image URL; Esc/q close; see Images",
        "",
        i18n::tr("help.heading.synthetic_entries"),
...
fn irc_help_lines() -> Vec<String> {
    [
        ...
        "",
        i18n::tr("help.heading.how_to_connect"),
        ...
        "",
        i18n::tr("help.heading.weechat_quick_setup"),
        ...
        "  /connect late",
        "",
        i18n::tr("help.heading.connection_troubleshooting"),
        ...
        "",
        i18n::tr("help.heading.good_arch_clients"),
        "  WeeChat           terminal-native; pacman -S weechat",
        "  Halloy            GUI client; pacman -S halloy",
        "",
        i18n::tr("help.heading.useful_irc_commands"),
        ...
        "",
        i18n::tr("help.heading.room_mapping"),
        ...
        "",
        i18n::tr("help.heading.token_behavior"),
        ...
        "",
        i18n::tr("help.heading.client_expectations"),
...
fn social_help_lines() -> Vec<String> {
    [
        i18n::tr("help.heading.social_surfaces"),
        "",
        ...
        "",
        i18n::tr("help.heading.readonly_profile_modal"),
...
fn directory_help_lines() -> Vec<String> {
    [
        ...
        "  Esc               cancel compose",
        "",
        i18n::tr("help.heading.public_web_profile"),
        ...
        "",
        i18n::tr("help.heading.projects_showcases"),
...
fn arcade_help_lines() -> Vec<String> {
    [
        ...
        "",
        i18n::tr("help.heading.leaderboard_badges"),
...
fn lobby_help_lines() -> Vec<String> {
    [
        ...
        "  Esc               close the Lobby",
        "",
        i18n::tr("help.heading.daily_matches"),
        ...
        "",
        i18n::tr("help.heading.house_tables"),
        ...
        "",
        i18n::tr("help.heading.at_a_table"),
...
fn lateania_help_lines() -> Vec<String> {
    [
        ...
        "",
        i18n::tr("help.heading.rebels_in_the_sky"),
        ...
        "  z                 flee combat",
        "",
        i18n::tr("help.heading.getting_around"),
...
fn overview_lines() -> Vec<String> {
    [
        ...
        "",
        i18n::tr("help.heading.global_keys"),
        ...
        "",
        i18n::tr("help.heading.room_favorites"),
        ...
        "",
        i18n::tr("help.heading.jump_search"),
        ...
        "  Esc               close",
        "",
        i18n::tr("help.heading.message_search"),
        ...
        "",
        i18n::tr("help.heading.home_room_shortcuts"),
        "  Ctrl+Q            open the Lobby (daily games + house tables)",
        "",
        i18n::tr("help.heading.this_modal"),
...
fn architecture_lines() -> Vec<String> {
    [
        ...
        "",
        i18n::tr("help.heading.what_runs_where"),
        ...
        "",
        i18n::tr("help.heading.state_and_persistence"),
        ...
        "",
        i18n::tr("help.heading.audio_stack"),
        ...
        "",
        i18n::tr("help.heading.user_facing_areas"),
        ...
        "",
        i18n::tr("help.heading.important_characteristics"),
...
fn news_help_lines() -> Vec<String> {
    [
        i18n::tr("help.heading.news_processing"),
        "",
        ...
        "",
        i18n::tr("help.heading.how_it_works_under_the_hood"),
        ...
        "",
        i18n::tr("help.heading.what_happens_after_submit"),
        ...
        "",
        i18n::tr("help.heading.good_inputs"),
        ...
        "",
        i18n::tr("help.heading.rss_relationship"),
...
fn settings_help_lines() -> Vec<String> {
    ...
    vec![
        i18n::tr("help.heading.settings_and_identity").to_string(),
        "".to_string(),
        "Your identity and preferences live in the settings modal.".to_string(),
        "".to_string(),
        i18n::tr("help.heading.tabs").to_string(),
        ...
        "".to_string(),
        i18n::tr("help.heading.what_you_can_set").to_string(),
        "  username".to_string(),
        ...
        "".to_string(),
        i18n::tr("help.heading.how_to_open").to_string(),
        ...
        "".to_string(),
        i18n::tr("help.heading.modal_controls").to_string(),
        ...
        "".to_string(),
        i18n::tr("help.heading.account_linking").to_string(),
        ...
        "    Land on Home page             land on Home (page 1) instead of the Clubhouse (page 0) when a session starts"
            .to_string(),
        "".to_string(),
        i18n::tr("help.heading.rss_tab").to_string(),
        ...
        "".to_string(),
        i18n::tr("help.heading.native_cli_config").to_string(),
        "".to_string(),
        ...
        "".to_string(),
        i18n::tr("help.heading.bot").to_string(),
        "".to_string(),
        ...
        "".to_string(),
        i18n::tr("help.heading.graybeard").to_string(),
        "".to_string(),
...
fn voice_help_lines() -> Vec<String> {
    [
        i18n::tr("help.heading.voice_rooms"),
        "",
        ...
        "",
        i18n::tr("help.heading.where_voice_shows_up"),
        ...
        "",
        i18n::tr("help.heading.joining_and_controls"),
        ...
        "",
        i18n::tr("help.heading.reading_the_roster"),
        ...
        "",
        i18n::tr("help.heading.top_right_badge"),
        ...
        "",
        i18n::tr("help.heading.staying_connected"),
        ...
        "",
        i18n::tr("help.heading.what_you_need_to_join"),
...
fn bonsai_help_lines() -> Vec<String> {
    [
        i18n::tr("help.heading.dynamic_bonsai"),
        "",
        ...
        "  q / Esc           close",
        "",
        i18n::tr("help.heading.two_meters"),
        ...
        "",
        i18n::tr("help.heading.selecting_a_tip"),
        ...
        "",
        i18n::tr("help.heading.how_a_growth_wave_works"),
        ...
        "",
        i18n::tr("help.heading.when_it_dies"),
        ...
        "",
        i18n::tr("help.heading.reading_the_tree"),
        ...
        "",
        i18n::tr("help.heading.chat_badge"),
        ...
        "────────────────────────────────────────",
        "",
        i18n::tr("help.heading.classic_bonsai"),
        "",
        ...
        "  600-700           Blossom",
        "",
        i18n::tr("help.heading.why_it_matters"),
        ...
        "",
        i18n::tr("help.heading.pet_companion"),
