...
use late_core::models::{
    ...
    pot::{POT_MAX_TICKETS_PER_USER, POT_TICKET_PRICE},
...
fn chips_help_lines() -> Vec<String> {
    ...
    vec![
        ...
        "".to_string(),
        "9. The pot".to_string(),
        format!("  A raffle, drawn once a day at 21:00 UTC. Tickets cost {} chips each.", thousands(POT_TICKET_PRICE)),
        "  /pot shows the pot, the tickets in it, what you hold, and how long is left.".to_string(),
        "  /pot buy N buys N tickets.".to_string(),
        format!("  One player may hold at most {POT_MAX_TICKETS_PER_USER} tickets in a pot, so the draw stays a raffle and not an auction."),
...
pub(crate) fn chat_help_lines(keep_composer_focused: bool) -> Vec<String> {
    ...
    let mut lines: Vec<String> = [
        ...
        "  /pot               the daily pot; /pot buy N buys N tickets",
