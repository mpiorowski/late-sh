...
pub fn chat_help_lines(keep_composer_focused: bool) -> Vec<String> {
    ...
    let mut lines: Vec<String> = [
        ...
        "  /challenge [@user] daily challenge (chess, battleship, connect4, reversi, checkers): lobby or directed",
...
fn lobby_help_lines() -> Vec<String> {
    [
        ...
        "",
        "Daily matches",
        "  /challenge [@user] post a chess, battleship, connect4, reversi, or checkers challenge",
