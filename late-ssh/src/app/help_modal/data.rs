...
pub(crate) fn chat_help_lines(keep_composer_focused: bool) -> Vec<String> {
    ...
    let mut lines: Vec<String> = [
        ...
        "  Sprout             comes up on the tank floor every 14 days, fed or not; cut it on its Shop row (Plants, -) within 7 days, or it roots as a plant; plants never die",
...
fn zen_help_lines() -> Vec<String> {
    [
        ...
        "  sprout            no page key: its Shop row (/shop, Plants) cuts it with - within the week",
        "",
        "Leaving",
