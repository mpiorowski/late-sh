...
- **Charm is tracked but inert.** It updates at the upstream points (charm +5/kill and −1 in the baskets event) but nothing *consumes* it until the phase-3 social systems (flirting, marriage). Soulpoints graduated in phase 1: they are the dead realm's HP pool.
