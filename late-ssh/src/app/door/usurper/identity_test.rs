...
// Known-answer test: this MUST match the identical KAT in the late-usurper
// host crate. Determinism alone would pass even if KEY_DOMAIN or a derivation
// step drifted on one side only.
#[test]
