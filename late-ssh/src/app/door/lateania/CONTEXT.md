...
- Last updated: 2026-08-15 (backtick joins the active-world keys: it detaches onto the backtick workspace cycle - a full autosaved leave plus a 5-minute recency window that keeps Lateania a cycle stop for a one-key rejoin of the same slot; see §3 Input capture contract and `lobby/CONTEXT.md`)
- Status: Active
