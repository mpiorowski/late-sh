...
// Known-answer test: this MUST match the identical KAT in the late-brogue
...
fn known_answer_fingerprint_is_stable() {
    assert_eq!(
        fingerprint("late-brogue-kat-v1"),
        "SHA256:lee3nvup/gosJ6lByidqJqfW/mzkNy7c0JEN+50Ppyc"
    );
}
