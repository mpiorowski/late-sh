...
- Last updated: 2026-07-28 (save isolation audited and now asserted fail-closed at image build by `scripts/brogue_verify_isolation.sh`; pinned upstream source copied to `upstream-brogue/`; `door-brogue` image tag `1.15.1-r2`)
- Status: Active
