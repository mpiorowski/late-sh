...
pub fn draw(frame: &mut Frame, popup: Rect, data: &LeaderboardData, user_id: Uuid, is_admin: bool) {
...
mod tests {
    ...
    fn win_streak_uses_only_space_left_after_all_time() {
        ...
        let all_time =
            preferred_score_list_area(reference, SCORE_ALL_TIME_OFFSET, &all_time_rows, me);
