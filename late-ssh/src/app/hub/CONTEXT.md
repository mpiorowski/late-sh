...
- Shop has implemented categories for Chat, Badges, Flags, Companions, Aquarium, and Ultimates (that order); keep this context in sync when adding another category or changing unlock gates.
