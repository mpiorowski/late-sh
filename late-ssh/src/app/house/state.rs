...
use crate::app::house::{registry::HouseTableRegistry, tables::HouseTable, types::InputAction};
use crate::usernames::UsernameLookup;

pub enum HouseTableClient {
    Poker(crate::app::house::poker::state::State),
    Blackjack(crate::app::house::blackjack::state::State),
    Asterion(crate::app::house::asterion::state::State),
    Tron(crate::app::house::tron::state::State),
}
...
impl HouseTableClient {
    ...
    pub fn handle_key(&mut self, byte: u8) -> InputAction {
        match self {
            Self::Poker(state) => crate::app::house::poker::input::handle_key(state, byte),
            Self::Blackjack(state) => {
                ...
                match crate::app::house::blackjack::input::handle_key(state, byte) {
                    ...
                    crate::app::house::blackjack::input::InputAction::Leave => InputAction::Leave,
                }
            }
            Self::Asterion(state) => crate::app::house::asterion::input::handle_key(state, byte),
            Self::Tron(state) => crate::app::house::tron::input::handle_key(state, byte),
        }
    }
    ...
    pub fn handle_arrow(&mut self, key: u8) -> bool {
        match self {
            ...
            Self::Asterion(state) => crate::app::house::asterion::input::handle_arrow(state, key),
            Self::Tron(state) => crate::app::house::tron::input::handle_arrow(state, key),
        }
    }
    ...
    pub fn preferred_game_height(&self, area: Rect) -> u16 {
        match self {
            ...
            Self::Tron(_) => crate::app::house::tron::ui::preferred_height(area),
        }
    }
    ...
    pub fn draw(&self, frame: &mut Frame, area: Rect, usernames: &UsernameLookup<'_>) {
        match self {
            Self::Poker(state) => {
                crate::app::house::poker::ui::draw_game(frame, area, state, usernames);
            }
            Self::Blackjack(state) => {
                crate::app::house::blackjack::ui::draw_game(frame, area, state, false, usernames);
            }
            Self::Asterion(state) => {
                crate::app::house::asterion::ui::draw_game(frame, area, state, usernames);
            }
            Self::Tron(state) => {
                crate::app::house::tron::ui::draw_game(frame, area, state, usernames);
            }
        }
    }
    ...
    pub fn can_sync_external_chip_balance(&self) -> bool {
        match self {
            ...
            Self::Blackjack(state) => {
                state.snapshot.phase == crate::app::house::blackjack::state::Phase::Betting
            }
            Self::Asterion(_) => false,
            Self::Tron(_) => false,
        }
