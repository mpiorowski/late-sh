...
use super::{data::TerminalHelpTopic, state::TerminalHelpModalState};

pub fn draw(frame: &mut Frame, area: Rect, state: &TerminalHelpModalState) {
    ...
    let footer = Line::from(vec![
        ...
        Span::styled("Esc/q/Ctrl+L", Style::default().fg(theme::AMBER_DIM())),
        Span::styled(" close", Style::default().fg(theme::TEXT_DIM())),
    ]);
    frame.render_widget(Paragraph::new(footer), layout[4]);
}

fn draw_tabs(frame: &mut Frame, area: Rect, selected: TerminalHelpTopic) {
