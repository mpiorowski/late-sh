...
| The rail | landing, `g` | `j/k` or arrows move, `Enter` opens (Board, a listing, an archive list, hang), `Esc` to the board, `Tab` from a pane back to the rail; the rail folds while the board has the keys |
