...
VALUES
    ('win_easy_sudoku', 'Win easy Sudoku', 'Solve today''s easy Sudoku.', 'daily', 'quick', 'puzzle', 'easy', 'daily_puzzle_win', '{"game":"sudoku","difficulty":"easy"}'::jsonb, 1, 150, 100),
    ('win_medium_sudoku', 'Win medium Sudoku', 'Solve today''s medium Sudoku.', 'daily', 'skill', 'puzzle', 'medium', 'daily_puzzle_win', '{"game":"sudoku","difficulty":"medium"}'::jsonb, 1, 375, 100),
    ('solve_easy_nonogram', 'Solve easy Nonogram', 'Solve today''s easy Nonogram.', 'daily', 'quick', 'puzzle', 'easy', 'daily_puzzle_win', '{"game":"nonogram","difficulty":"easy"}'::jsonb, 1, 150, 100),
    ('solve_medium_nonogram', 'Solve medium Nonogram', 'Solve today''s medium Nonogram.', 'daily', 'skill', 'puzzle', 'medium', 'daily_puzzle_win', '{"game":"nonogram","difficulty":"medium"}'::jsonb, 1, 375, 100),
    ('clear_easy_minesweeper', 'Clear easy Minesweeper', 'Clear today''s easy Minesweeper board.', 'daily', 'quick', 'puzzle', 'easy', 'daily_puzzle_win', '{"game":"minesweeper","difficulty":"easy"}'::jsonb, 1, 150, 100),
    ('clear_medium_minesweeper', 'Clear medium Minesweeper', 'Clear today''s medium Minesweeper board.', 'daily', 'skill', 'puzzle', 'medium', 'daily_puzzle_win', '{"game":"minesweeper","difficulty":"medium"}'::jsonb, 1, 375, 100),
    ('win_draw_1_solitaire', 'Win draw-1 Solitaire', 'Finish today''s draw-1 Solitaire deal.', 'daily', 'skill', 'puzzle', 'medium', 'daily_puzzle_win', '{"game":"solitaire","difficulty":"draw-1"}'::jsonb, 1, 375, 100),
    ('daily_tetris_score', 'Score 25,000 in Tetris', 'Finish a Tetris run with at least 25,000 points.', 'daily', 'skill', 'arcade', 'medium', 'arcade_score', '{"game":"tetris"}'::jsonb, 25000, 375, 100),
    ('daily_2048_score', 'Score 12,000 in 2048', 'Finish a 2048 run with at least 12,000 points.', 'daily', 'skill', 'arcade', 'medium', 'arcade_score', '{"game":"2048"}'::jsonb, 12000, 375, 100),
    ('daily_snake_score', 'Score 10,000 in Snake', 'Finish a Snake run with at least 10,000 points.', 'daily', 'skill', 'arcade', 'medium', 'arcade_score', '{"game":"snake"}'::jsonb, 10000, 375, 100),
    ('daily_blackjack_hands', 'Play 20 Blackjack hands', 'Finish 20 Blackjack hands.', 'daily', 'skill', 'casino', 'medium', 'room_rounds_played', '{"game":"blackjack"}'::jsonb, 20, 400, 100),
    ...
    ('win_draw_3_solitaire', 'Win draw-3 Solitaire', 'Finish today''s draw-3 Solitaire deal.', 'weekly', 'skill', 'puzzle', 'hard', 'daily_puzzle_win', '{"game":"solitaire","difficulty":"draw-3"}'::jsonb, 1, 750, 100),
    ('weekly_tetris_score', 'Score 100,000 in Tetris', 'Finish a Tetris run with at least 100,000 points.', 'weekly', 'skill', 'arcade', 'hard', 'arcade_score', '{"game":"tetris"}'::jsonb, 100000, 750, 100),
    ('weekly_2048_score', 'Score 40,000 in 2048', 'Finish a 2048 run with at least 40,000 points.', 'weekly', 'skill', 'arcade', 'hard', 'arcade_score', '{"game":"2048"}'::jsonb, 40000, 750, 100),
    ('weekly_snake_score', 'Score 30,000 in Snake', 'Finish a Snake run with at least 30,000 points.', 'weekly', 'skill', 'arcade', 'hard', 'arcade_score', '{"game":"snake"}'::jsonb, 30000, 750, 100),
