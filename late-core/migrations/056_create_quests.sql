...
VALUES
    ...
    ('daily_tetris_score', 'Score 25,000 in Tetris', 'Finish a Tetris run with at least 25,000 points.', 'daily', 'skill', 'arcade', 'medium', 'arcade_score', '{"game":"tetris"}'::jsonb, 25000, 375, 100, true, 'assignment', NULL),
    ...
    ('weekly_tetris_score', 'Score 100,000 in Tetris', 'Finish a Tetris run with at least 100,000 points.', 'weekly', 'skill', 'arcade', 'hard', 'arcade_score', '{"game":"tetris"}'::jsonb, 100000, 750, 100, true, 'assignment', NULL),
